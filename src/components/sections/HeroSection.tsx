        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
          ...
          <div className={`transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="relative">
              <div className="absolute -inset-1.5 bg-primary/30 rounded-full blur-md"></div>
              <Avatar className="h-64 w-64 rounded-full border-4 border-primary/50 overflow-hidden">
                <AvatarImage src="/images/profile-photo.jpg" alt="Abhin C" className="object-cover" />
                <AvatarFallback className="text-4xl bg-primary/20">AC</AvatarFallback>
              </Avatar>
            </div>
          </div>
        </div>
